...
In this sense, hard-spheres are completely **entropy-driven** system. For a collection of identical (**monodisperse**) hard spheres the entropy is solely **configurational** and correspods to the number of possible arrangements. This constraine only by the accessible volume, of which we have seen an instance when considering the depletion interactions.
