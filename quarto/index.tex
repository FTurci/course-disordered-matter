...
\begin{tcolorbox}[enhanced jigsaw, colback=white, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Solution}, coltitle=black, breakable, toptitle=1mm, opacitybacktitle=0.6, bottomtitle=1mm, colbacktitle=quarto-callout-caution-color!10!white, leftrule=.75mm, colframe=quarto-callout-caution-color-frame, bottomrule=.15mm, left=2mm, titlerule=0mm, toprule=.15mm, arc=.35mm, rightrule=.15mm, opacityback=0]
