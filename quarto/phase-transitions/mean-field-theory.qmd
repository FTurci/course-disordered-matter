...
## Spontaneous symmetry breaking {#sec-breaking}
 ...
 ![Schematic of the form of the free energy for a critical, subcritical and supercritical temperature](Figs/freeenergy_color.png){width=60%  #fig-freeenergy}
...
@fig-isingmag.
 ...
 ![Phase diagram of a simple magnet in the $m$-$T$ plane.](Figs/isingmag.png){width=70% fig-align="center" #fig-isingmag}
