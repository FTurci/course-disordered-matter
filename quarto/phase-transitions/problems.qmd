...
**(a)** Show that the equation of state for the model is

$$
H=2\tilde{a}_2tm+4a_4m^3\:.
$$

**(b)** Use the near-critical power law behaviour of $m$ to show that the equation of state may be written in the scaling form
...
**(c)** Deduce that $g(x)=x+1$ up to a choice of scale for $\tilde{a}_2$ and $a_4$.
