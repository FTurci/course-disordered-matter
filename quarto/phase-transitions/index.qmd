...
* Detailed e-notes (see Blackboard) can be viewed on a variety of devices. Pdf is available on request. 

* We will give 'traditional' lectures (XXday, YYYday) in which we use slides to summarise and explain the lecture content. Questions are welcome during lectures (within reason...)
