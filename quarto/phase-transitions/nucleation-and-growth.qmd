...
# Dynamics of first order phase transitions: nucleation and growth
...
## Classical Nucleation Theory: Homogeneous Nucleation
...
$$
 ...
 ![Free energy barrier $\Delta F(r)$ for nucleation of a spherical droplet as a function of radius $R$ (schematic)](Figs/cnt_schematic.png){width=80% fig-align="center" #fig-cnt-schem}
...
## Late-Time Dynamics: Domain Growth and Coarsening

Following successful nucleation of a supercritical droplet, the system enters a regime where the global transformation is driven by the deterministic growth of domains of the stable phase. This phase of the dynamics is often referred to as coarsening
 or phase ordering dynamics.

At late times, the dynamics are controlled not by rare fluctuations, but by the energetically-driven evolution of domain structures. 
The nature of domain growth depends sensitively on whether the order parameter is conserved or not.
...
Schematic illustrations of domain morphology resulting from non-conserved and conserved dynamics.
:::
