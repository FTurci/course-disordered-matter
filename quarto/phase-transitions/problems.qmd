...
where:
- $\Delta G_v < 0$ is the free energy change per unit volume due to the phase change,
- $\gamma > 0$ is the interfacial energy between the solid and liquid phases.
...
**(c)** Explain qualitatively how the degree of undercooling $\Delta T$ affects the rate of nucleation. Use the fact that $\Delta G_v \propto \Delta T$ to support your answer.
