...
Other observables (those which are second derivatives of the free energy) such as the heat capacity can't be calculated as simple averages. Instead they are calculated as a variance. The formula for the heat capacity (cf. problem set) is 
...
- *The program calculates the average form of the 2d structure factor $S(\mathbf{k})$. Using this, obtain and plot the radially averaged structure 1d factor $S(|k|)$. *
  **[6 marks]**
