...
<table>
  ...
  <tr>
    <th>Solid</th>
    <td>Solid suspension:<br>pigmented plastics,<br>stained glass,<br>ruby glass, opal, pearl</td>
    <td>Sol, colloidal suspension:<br>metal sol,<br>toothpaste, paint,<br>ink, clay slurries, mud</td>
    <td>Solid aerosol:<br>smoke, dust</td>
  </tr>
  <tr>
    <th>Liquid</th>
    <td>Solid emulsion:<br>bituminous road paving,<br>ice cream</td>
    <td>Emulsion:<br>milk, mayonnaise,<br>butter, pharmaceutical creams</td>
    <td>Liquid aerosol:<br>fog, mist, tobacco smoke,<br>hair spray</td>
  </tr>
  <tr>
    <th>Gas</th>
    <td>Solid foam:<br>zeolites, expanded polystyrene,<br>‘silica gel’</td>
    <td>Foam:<br>froths, soap foam,<br>fire-extinguisher foam</td>
    <td>—</td>
  </tr>
</table>


Clearly, collidal materials form an incredibly diverse class, and surround us in oure everyday lives. Here are some visual examples from the table above:
...
## The prototype: hard-sphere colloids
