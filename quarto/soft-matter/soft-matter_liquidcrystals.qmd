...
$$
\mathbf{Q}=\frac{3}{2} \mathcal{S}\left(\mathbf{n} \otimes \mathbf{n}-\frac{1}{3} \mathbf{I}\right)=\mathcal{S}\left(\frac{3}{2} \mathbf{n} \otimes \mathbf{n}-\frac{1}{2} \mathbf{I}\right) .
$$
