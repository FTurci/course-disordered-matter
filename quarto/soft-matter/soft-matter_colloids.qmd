...
where $\rho_p$ is the number density of polymers in the ideal reservoir related to their volume fraction $\eta_p^r=\rho_p v_p = \frac{\pi}{6} \rho_p^r \sigma_p^3 $, with $v_p= \dfrac{pi}{6}\sigma_p^3$.
...
& =  -k_B T \dfrac{\eta_p}{v_p} V_{\mathrm{overlap}(r)}
\end{aligned}
$$
...
$$
W_{\rm AO} (r) = - \dfrac{4 \pi \eta_p^r k_B T}{3} (R+\delta)^3\left[1-\dfrac{3}{4} \dfrac{r}{R+\delta}+\frac{1}{16}\left(\dfrac{r}{R+\delta}\right)^3\right] \quad 2R\leq r< 2R+\delta
$$ 
</div>
...
$$
W_{\rm AO}(r) = -\frac{4\pi \eta_p^r k_B T}{3} [R(1+q)]^3 \left[1 - \frac{3}{4} \frac{r}{R(1+q)} + \frac{1}{16} \left(\frac{r}{R(1+q)}\right)^3 \right] \quad 2R \leq r < 2R(1+q)
$$
...
eta_p = 0.1       # Polymer concentration (dimensionless)
