...
It is important to note, however, that the disordered packing at high volume fractions are not minima of the free energy. There are various ways to see this.

show that the densest possible packing of hard spheres is achieved by arranging them in a crystalline lattice. In three dimensions, the densest packings are the face-centered cubic (FCC) and hexagonal close-packed (HCP) structures, both of which have a maximum packing fraction of
...
The video below shows instead the results of a Monte-Carlo simulation at packing $\phi=0.493$ for a small system of 32 particles. Smal systems have enhanced fluctuations, and since the overal packing fraction is very close to the freezing line, we see spontaneous freezing and unfreezing of the small system.

{{< video figs/melt_freeze.mp4 >}}

In conclusion, colloidal hard spheres have a one-dimensional pahse diagram, that depends only on the packing fraction but with various distinct phases
