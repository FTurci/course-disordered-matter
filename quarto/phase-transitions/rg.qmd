...
point centre, $I$, a coarse-grained or block variable $S(L)$ defined
...
can only take two possible values, the block variables $S(L)$ have
...
implying a vector order parameter, with $n=2$ (the so called XY model) or $n=3$ (Heisenberg model), respectively. It
...
![General flow in coupling space](Figs/flow2.png){#fig-flow2 width=60%}
