...
The form can be expressed in terms of  $q = \delta / R $ by using

$$
V_{\rm overlap}(r) = \frac{4 \pi}{3} (R+\delta)^3
\left[ 1 - \frac{3}{4}\frac{r}{R+\delta} + \frac{1}{16}\left(\frac{r}{R+\delta}\right)^3 \right],
\quad 2R \le r < 2(R+\delta),
$$

which yields the **AO potential**:

$$
W_{\mathrm{AO}}(r)=-\frac{4 \pi \rho_p k_B T}{3} R^3(1+q)^3\left[1-\frac{3}{4} \frac{r}{R(1+q)}+\frac{1}{16}\left(\frac{r}{R(1+q)}\right)^3\right]
$$
