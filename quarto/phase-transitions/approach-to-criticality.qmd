...
reference="fig:sing"} as a function of $t$.
 ...
 ![Singular behaviour of the correlation length and order parameter in the vicinity of the critical point as a function of the reduced temperature $t$.](Figs/sing.png){width=60% fig-align="center" #fig-sing}
