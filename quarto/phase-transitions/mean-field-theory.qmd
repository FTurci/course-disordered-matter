...
reference="fig:mfsum"}.
 ...
 ![Mean field behaviour of the Ising magnetisation and susceptibility (schematic)](Figs/summary.png){width=80% fig-align="center" #fig-isingpd}
...
reference="fig:landau"}
 ...
 ![Form of the Landau Free energy for a selection of values of the $a$ parameter.](Figs/landau.png){width=80% fig-align="center" #fig-landau}
