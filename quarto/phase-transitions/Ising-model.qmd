...
The animation below lets you see qualitatively how the typical number of domain walls varies with temperature. If you'd lke to explore more quantitatively, a python code performing a Monte Carlo simulation is available.
...
#Monte Carlo simulation of the 1d Ising chain with periodic boundary conditions
import numpy as np
