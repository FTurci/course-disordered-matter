...
corresponding to a dynamic exponent $z = 2$, where in general $L(t)\sim t^{1/z}$. The growth is driven by reduction of the total interfacial area—regions of high curvature (small domains) shrink and are absorbed by larger, flatter ones.
