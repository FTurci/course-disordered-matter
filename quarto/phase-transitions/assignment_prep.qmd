...
Other observables (those which are second derivatives of the free energy) such as the heat capacity can't be calculated as simple averages. Instead they are calculated as a variance. The formula for the heat capacity  (c.f. problem set) is 

$$
C=\frac{1}{L^dk_BT^2} \left[\overline{E^2} - \overline{E}^2\right] = \frac{(\Delta E)^2}{L^d k_BT^2}
$$
...
**The assignment itself will be released at 12:30 pm on Monday 13th October 2025 on Blackboard via the Unit Assessment tab. The submission deadline is Monday 27th October 2025 at 09:30.**
