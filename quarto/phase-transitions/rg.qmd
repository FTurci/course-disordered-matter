...
coarse-graining) is shown in @fig-c1(ai). The succeeding figures, @fig-c1(aii) and @fig-c1(aiii), show the
...
(@fig-c1(bii) and (biii)). This time the coarse-graining smoothes out the microstructure
...
typical arrangement; @fig-c2(aii) and (aiii) show the results of coarse-graining
...
scales. A nice illustration of critical point scale invariance in the Ising model can be viewed [here](https://www.youtube.com/watch?v=fi-g2ET97W8&ab_channel=DouglasAshton).
