...
where $\rho_p$ is the number density of polymers in the ideal reservoir related to their volume fraction \$\phi\_p\^r=\rho\_p v_p = \frac{\pi}{6} \rho\_p\^r \sigma\_p\^3 \$, with $v_p= \dfrac{pi}{6}\sigma_p^3$.
