...
chemical potential. One can also fix the particle number to some prescribed value- the corresponding set of microstates then define the canonical ensemble (see precourse reading) of the lattice gas at that density. 
