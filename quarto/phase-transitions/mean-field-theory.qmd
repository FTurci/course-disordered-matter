...
@fig-isingmag.
 ...
 ![Phase diagram of a simple magnet in the $m$-$T$ plane.](Figs/isingmag_new.png){width=60% fig-align="center" #fig-isingmag}
...
jumps discontinuously from $m=m^\star$ to $m=-m^\star$.
 ...
 ![Phase diagram of a simple magnet in the $H$-$T$ plane.](Figs/isingpdH.png){width=50% #fig-isingpdH}
...
are shown in @fig-mfsum 
 ...
 ![Mean field behaviour of the Ising magnetisation and susceptibility (schematic)](Figs/summary.png){width=60% fig-align="center" #fig-mfsum}
