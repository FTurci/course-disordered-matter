...
![Magnetisation of CrBr$_3$ in the critical region plotted in scaled form (see text).](Figs/scaling1.jpg){width=80%}
...
![Schematic of the near-critical temperature dependence of the magnet susceptibility in a finite-sized system.](Figs/shift.png){width=60%}
