...
- an intermediate regime around the reorientation time $\tau_R$ $\operatorname{MSD}(\tau)=4 D_{\mathrm{T}} \tau+2 v^2 \tau^2 $ leading to **super-diffusive** motion (ballistic)
