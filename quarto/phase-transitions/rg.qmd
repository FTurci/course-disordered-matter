...
The results is illustrated in @fig-confscomp. See also the [full demonstration](https://www.youtube.com/watch?v=Kd4UvhUsBAU&ab_channel=DouglasAshton) on YouTube.

::: {#fig-confscomp layout-ncol=1}
![2D critical Ising model and 2d criticcal Lennard-Jones fluid at small lengthscales](Figs/fluid-magnet.png){width=50%}
...
{{< video Movies/universality.mov  width=180% title="Zooming out">}}
...
## The effective coupling viewpoint of the renormalization group (non examinable) 
